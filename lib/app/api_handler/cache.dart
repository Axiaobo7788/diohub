...
class APICache {
  ...
  APICache._copyWith({required this.cacheOptions, this.maxAge});
  ...
  APICache.refresh() : this(cachePolicy: CachePolicy.refresh);
...
CacheKeyBuilder generateUUIDFromRequest() =>
    ({
      ...
      final Object? body,
    }) => const Uuid().v5(Uuid.NAMESPACE_URL, headers?.toString() ?? '$url');
