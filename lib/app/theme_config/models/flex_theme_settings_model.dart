...
class FlexThemeSettingsModel {
  ...
  FlexThemeSettingsModel copyWith({
    ...
    String? fontFamily,
    FlexSubThemes? subThemes,
    ColorScheme? colorScheme,
    bool? clearScheme,
    bool? clearVariant,
    bool? clearBlendLevel,
    bool? clearUsedColors,
    bool? clearDarkIsTrueBlack,
    bool? clearSwapColors,
    bool? clearSwapLegacyColors,
    bool? clearSurfaceMode,
    bool? clearFontFamily,
    bool? clearSubThemes,
    bool? clearColorScheme,
  }) {
    return FlexThemeSettingsModel(
      scheme: (clearScheme == true) ? null : (scheme ?? this.scheme),
      lightScheme: lightScheme ?? this.lightScheme,
      darkScheme: darkScheme ?? this.darkScheme,
      variant: (clearVariant == true) ? null : (variant ?? this.variant),
      blendLevel:
          (clearBlendLevel == true) ? null : (blendLevel ?? this.blendLevel),
      usedColors:
          (clearUsedColors == true) ? null : (usedColors ?? this.usedColors),
      darkIsTrueBlack: (clearDarkIsTrueBlack == true)
          ? null
          : (darkIsTrueBlack ?? this.darkIsTrueBlack),
      swapColors:
          (clearSwapColors == true) ? null : (swapColors ?? this.swapColors),
      swapLegacyColors: (clearSwapLegacyColors == true)
          ? null
          : (swapLegacyColors ?? this.swapLegacyColors),
      surfaceMode:
          (clearSurfaceMode == true) ? null : (surfaceMode ?? this.surfaceMode),
      ...
      fontFamily:
          (clearFontFamily == true) ? null : (fontFamily ?? this.fontFamily),
      subThemes:
          (clearSubThemes == true) ? null : (subThemes ?? this.subThemes),
      colorScheme:
          (clearColorScheme == true) ? null : (colorScheme ?? this.colorScheme),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (onErrorContainer != null) 'onErrorContainer': onErrorContainer!.value,
      ...
      if (onSurfaceVariant != null) 'onSurfaceVariant': onSurfaceVariant!.value,
      ...
      if (onInverseSurface != null) 'onInverseSurface': onInverseSurface!.value,
  ...
  /// Create from JSON
  factory FlexThemeSettingsModel.fromJson(Map<String, dynamic> json) {
    return FlexThemeSettingsModel(
      ...
      onTertiary:
          json['onTertiary'] != null ? Color(json['onTertiary'] as int) : null,
