...
class TimelineCommitContent extends StatelessWidget {
  ...
  final String? userLogin; // Optional, not currently used but kept for compatibility
  final String? userEmail; // Optional, not currently used but kept for compatibility
