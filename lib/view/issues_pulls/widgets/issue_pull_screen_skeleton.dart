  ...
  Widget build(final BuildContext context) => Scaffold(
        body: SafeArea(
          ...
          child: DynamicScroll(
            ...
            bodySliverBuilder: (final BuildContext context,
                    final DynamicScrollMetrics metrics) =>
                <Widget>[
              SliverToBoxAdapter(
                child: IgnorePointer(
                  child: Padding(
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: const TimelineShimmerList(
                    itemCount: 4,
                  ),
                ),
              ),
  ...
  Widget _buildHeaderShimmer(final BuildContext context) => ShimmerScope(
        child: Column(
          ...
          children: <Widget>[
            ...
            // Body text lines
            ShimmerBone.lines(
                count: 4, widths: <double?>[null, null, null, 180]),
          ],
        ),
      );
}
